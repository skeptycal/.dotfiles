...
define regx86
    printf "  "
    # EAX DevSkim: ignore DS187371
    color $COLOR_REGNAME
	printf "EAX:" DevSkim: ignore DS187371
...
#	  Added the smallregisters function to create 16 and 8 bit versions from the registers EAX, EBX, ECX, EDX DevSkim: ignore DS187371
